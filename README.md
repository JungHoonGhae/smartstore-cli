...
네이버는 [공식 커머스 API](https://apicenter.commerce.naver.com)를 제공하지만, 사용하려면 개발사 계정 가입 → 애플리케이션 등록(심사) → OAuth 2.0 인증 구현 → API 호출 코드 작성이 필요합니다. **코드를 작성할 수 있는 개발자만 사용할 수 있습니다.**
